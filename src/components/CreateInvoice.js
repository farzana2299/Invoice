            ...
            <div className='ci2'>
                <Row>
                    <Col lg={12} md={12} sm={12} xs={12}>
                        <div className='text-start ps-5 pt-2 container' style={{ position: 'relative', top: '10px' }}>
                            <h3>Bill To</h3>
                            <i class="fa-solid fa-user-plus" style={{ color: 'darkviolet' }}></i>
                            <div style={{ position: 'relative', bottom: '21px', left: '20px' }}> <h6>Add Client</h6></div>
                        </div>
                    </Col>
                </Row>
            </div>
