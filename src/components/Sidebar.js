                    ...
                    <Offcanvas.Body>
                        <div>
                            ...
                            <Link style={{ textDecoration: 'none', color: 'black' }}>
                                <div className='sb1 mt-3 mb-3'>
                                    <div className='sb2'>
                                        <h4><i class="fa-solid fa-file-invoice" style={{ color: 'lightgreen' }}></i>  Invoices</h4>
                                    </div>
                                </div>
                            </Link>
                            <Link to={'/clients'} style={{ textDecoration: 'none', color: 'black' }}>
                                <div className='sb1 mt-3 mb-3'>
                                    <div className='sb2'>
                                        <h4><i class="fa-solid fa-user" style={{ color: 'red' }}></i>  Clients</h4>
                                    </div>
                                </div>
                            </Link>
                            <Link style={{ textDecoration: 'none', color: 'black' }}>
                                <div className='sb1 mt-3 mb-3'>
                                    <div className='sb2'>
                                        <h4><i class="fa-solid fa-briefcase" style={{ color: 'violet' }}></i>  Reports</h4>
                                    </div>
                                </div>
                            </Link>
                            <Link style={{ textDecoration: 'none', color: 'black' }}>
                                <div className='sb1 mt-3 mb-3'>
                                    <div className='sb2'>
                                        <h4><i class="fa-solid fa-gear" style={{ color: 'darkblue' }}></i>  Settings</h4>
                                    </div>
                                </div>
                            </Link>
